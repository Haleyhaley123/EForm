...
//        {
//            this._wordApp = new Microsoft.Office.Interop.Word.Application();
...
//        public string ExcuteReport(object pathTemplateFile, object directory_destination_folder, Dictionary<string, string> finAndRelpaces)
//        {
...
//                    myWordDoc.Activate();
//                    FindAndReplace(_wordApp, finAndRelpaces);
...
//                    myWordDoc.Close();
//                    // convert
//                    var urlpdf = ConvertWordToPdf((string)pathOutFile);
//                    this._wordApp.Quit();
//                    return (string)urlpdf;
//                }
//                catch (Exception e)
//                {
//                    if (myWordDoc != null)
...
//            return null;
//        }
//        private void FindAndReplace(Microsoft.Office.Interop.Word.Application wordApp, Dictionary<string, string> finAndRelpaces)
//        {
//            foreach (KeyValuePair<string, string> keyvalue in finAndRelpaces)
//            {
//                object key = keyvalue.Key;
//                object va = keyvalue.Value;
//                if (key.ToString() == "[CLINICAL]" && va.ToString().Length > 250)
//                {
//                }
//                AddReplace(wordApp, key, va);
//            }
//        }
//        private void AddReplace(Microsoft.Office.Interop.Word.Application wordApp, object key, object va)
//        {
