    ...
    {   
        ...
        public IHttpActionResult SynInforCustomer(Guid visitId)
        {
            ...
            return Content(HttpStatusCode.OK, new
            {
                ...
                CustomerRelationship = GetRelationShipResultFromOH(visit.Version,custormer?.PID, "HU")
            });
        }
        private dynamic GetRelationShipResultFromOH(int version, string pId, string relationshipCode)
        {
