...
namespace EForm.Controllers.IPDControllers
{
    ...
    public class IPDDocumentController : BaseIPDApiController
    {
        ...
        public IHttpActionResult IPDTransferLetterAPI(Guid id)
        {
            ...
            var reason_1 = medical_record_datas.FirstOrDefault(e => e.Code == "IPDRFT1SHT");
            var reason_1_data = unitOfWork.MasterDataRepository.FirstOrDefault(m => m.Code == "IPDRFT1SHT");
            var reason_2 = medical_record_datas.FirstOrDefault(e => e.Code == "IPDRFT1LOG");
            var reason_2_data = unitOfWork.MasterDataRepository.FirstOrDefault(m => m.Code == "IPDRFT1LOG");
