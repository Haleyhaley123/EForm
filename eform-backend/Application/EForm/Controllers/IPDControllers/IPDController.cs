...
namespace EForm.Controllers.IPDControllers
{
    ...
    public class IPDController : BaseIPDApiController
    {
        ...
        private dynamic GetIPDForNurse(IPDParameterModel request)
        {
            ...
            var specialty_setup_forms = GetSpecialtySetupForm(specialty_id, md_setup_menu);
            ...
            if (count > 0)
            {
                ...
                var items = query.Skip((request.PageNumber - 1) * request.PageSize)
                               ...
                               .ToList()
                               .Select(e => DataFormatted(e, timeStartUpdate, specialty_setup_forms, md_setup_menu));
        ...
        private dynamic DataFormatted(IPDQueryModel visit, string timeStartUpdate, List<MasterData> list_specialty_setup, List<MasterData> md_setup)
        {
            return new
            {
                visit.Id,
                ...
                MedicalRecordType = GetMedicalRecordsSavedOrSetup(visit.Id, md_setup, list_specialty_setup),
