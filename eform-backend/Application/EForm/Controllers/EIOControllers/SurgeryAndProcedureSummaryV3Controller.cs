...
namespace EForm.Controllers.EIOControllers
{
    ...
    public class SurgeryAndProcedureSummaryV3Controller : BaseApiController
    {
        ...
        public async Task<IHttpActionResult> GetEkipFromOr(string type, Guid visitId)
        {
            ...
            {
                ThoiGianThucHien = e.ThoiGianThucHien.Value.ToString(Constants.TIME_DATE_FORMAT_WITHOUT_SECOND),
                ItemCode = e.ItemCode,
                ItemName = e.ItemName,
                UserName_PTVChinh = e.UserName_PTVChinh,
                UserName_Bs_GayMe = e.UserName_Bs_GayMe,
                UserName_Nurse_PhuMe = new { e.UserName_Nurse_PhuMe_1, e.UserName_Nurse_PhuMe_2 },
                UserName_PTV_Phu = new
                {
                    e.UserName_PTV_Phu_1,
                    e.UserName_PTV_Phu_2,
                    e.UserName_PTV_Phu_3,
                    e.UserName_PTV_Phu_4,
                    e.UserName_PTV_Phu_5,
                    e.UserName_PTV_Phu_6,
                    e.UserName_PTV_Phu_7,
                    e.UserName_PTV_Phu_8
                },
                UserName_Nurse_Tool = new { e.UserName_Nurse_Tool_1, e.UserName_Nurse_Tool_2 },
                UserName_Nurse_Runout = new
                {
                    e.UserName_Nurse_Runout_1,
                    e.UserName_Nurse_Runout_2,
                    e.UserName_Nurse_Runout_3,
                    e.UserName_Nurse_Runout_4,
                    e.UserName_Nurse_Runout_5,
                    e.UserName_Nurse_Runout_6
                },
            }).OrderByDescending(e => e.ThoiGianThucHien).ToList();
