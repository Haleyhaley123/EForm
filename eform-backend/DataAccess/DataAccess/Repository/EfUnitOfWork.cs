...
namespace DataAccess.Repository
{
    public class EfUnitOfWork : DbContext, IUnitOfWork
    {
        ...
        private readonly EfGenericRepository<Esigns> _esignsRepo;
        ...
        public EfUnitOfWork()
        {
           ...
           _SurgeryAndProcedureSummaryV3Repo = new EfGenericRepository<SurgeryAndProcedureSummaryV3>(context);
            ...
            _esignsRepo = new EfGenericRepository<Esigns>(context);
        ...
        public IGenericRepository<Esigns> EsignRepository => _esignsRepo;
