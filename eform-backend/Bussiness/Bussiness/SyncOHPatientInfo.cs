    ...
    public class SyncOHPatientInfo
    {
        ...
        private static Customer BuildOhCustomerResult(OhCustomer oh_customer)
        {
            ...
            return new Customer()
            {
                ...
                MOHNationality = oh_customer.QuocTich,
        ...
        public async Task<Customer> SyncCustomerAsync(string pid, Guid? customer_id = null)
        {
            var oh_customer = await GetOHPatientInfoByPidAsync(pid);
            var local_customer = customer_id == null ? _unitOfWork.CustomerRepository.Find(e => !e.IsDeleted && e.PID == pid).FirstOrDefault() : _unitOfWork.CustomerRepository.Find(e => !e.IsDeleted && e.Id == customer_id).FirstOrDefault();
            ...
            if (oh_customer != null)
            {
                ...
                local_customer.Nationality = oh_customer.Nationality;
                local_customer.MOHNationality = oh_customer.MOHNationality;
                if (is_new_customer)
                {
