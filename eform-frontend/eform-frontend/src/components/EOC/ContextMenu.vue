<template>
  <MDContextMenu :VisitId="VisitId" :MenuPositon='MenuPositon' :Customer='Customer' :menuItems="menuItems" Type="EOC"/>
</template>
<script>
export default {
  name: 'EOC-CONTEXT-MENU',
  ...
  data () {
    return {
      menuItems: [
        ...
        {
          ViName: 'Phiếu khám bệnh',
          EnName: 'Patient Examination Note',
