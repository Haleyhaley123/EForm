...
namespace EForm.Utils
{
    public class ClosestVisitIn24H
    {
        ...
        public ClosestVisitIn24H(Guid? customer_id, DateTime admitted_date)
        {
        ...
        private VisitIdModel GetClosestVisitIn24H(Guid? customer_id, DateTime admitted_date)
        {
            ...
            List<VisitIdModel> ed = unitOfWork.EDRepository.Find(
                e => !e.IsDeleted &&
                e.CustomerId != null &&
            ...
            List<VisitIdModel> opd = unitOfWork.OPDRepository.Find(
                e => !e.IsDeleted &&
                e.CustomerId != null &&
                e.CustomerId == customer_id &&
                e.AdmittedDate != null &&
            ...
            List<VisitIdModel> ipd = unitOfWork.IPDRepository.Find(
                e => !e.IsDeleted &&
                e.CustomerId != null &&
                e.CustomerId == customer_id &&
                e.AdmittedDate != null &&
        ...
        private dynamic GetEDVitalSignInInitialAssessment()
        {
            ...
            var vital_sign = unitOfWork.EDObservationChartDataRepository.Find(
                e => !e.IsDeleted &&
        ...
        private dynamic GetEDVitalSignInRetail()
        {
            ...
            return from data_sql in unitOfWork.EIOAssessmentForRetailServicePatientDataRepository.AsQueryable()
                   .Where(
                        e => !e.IsDeleted &&
                   ...
                   join master_sql in unitOfWork.MasterDataRepository.Find(e => !e.IsDeleted).AsQueryable()
        ...
        private dynamic GetOPDVitalSignInInitialAssessment()
        {
            ...
            return from data_sql in unitOfWork.OPDInitialAssessmentForShortTermDataRepository.AsQueryable()
                   .Where(
                        e => !e.IsDeleted &&
        ...
        private dynamic GetOPDVitalSignInTelehealth()
        {
            ...
            return from data_sql in unitOfWork.OPDInitialAssessmentForTelehealthDataRepository.AsQueryable()
                   .Where(
                        e => !e.IsDeleted &&
        ...
        private dynamic GetIPDVitalSign()
        {
            ...
            return from data_sql in unitOfWork.IPDInitialAssessmentForAdultDataRepository.AsQueryable()
                   .Where(
                        e => !e.IsDeleted &&
        ...
        private dynamic GetEDDiseasesScreeningInETR(int version)
        {
            ...
            return unitOfWork.EmergencyTriageRecordDataRepository.Find(
                        e => !e.IsDeleted &&
        ...
        private dynamic GetEDDiseasesScreeningInRetailService(int version)
        {
            ...
            return unitOfWork.EIOAssessmentForRetailServicePatientDataRepository.Find(
                        e => !e.IsDeleted &&
                        e.EDAssessmentForRetailServicePatientId != null &&
        ...
        private dynamic GetIPDDiseasesScreening()
        {
            ...
            string[] list_code = Constant.DISEASES_SCREENING[ia.Version]["IPDAdult"];
            Guid? diseases_screening_id = this.Visit.Object.IPDInitialAssessmentForAdultId;
            var datas = unitOfWork.IPDInitialAssessmentForAdultDataRepository.Find(
                        e => !e.IsDeleted &&
                        e.IPDInitialAssessmentForAdultId != null &&
