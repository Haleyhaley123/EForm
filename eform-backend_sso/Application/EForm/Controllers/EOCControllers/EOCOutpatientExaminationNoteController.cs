        ...
        public IHttpActionResult UpdateExaminationNoteAPI(Guid id, [FromBody]JObject request)
        {
            ...
            if (eocHandOverCheckList == null)
            {
                var form_data = new EOCHandOverCheckList
                {
                    ...
                    HandOverUnitPhysicianId = visit.SpecialtyId,
                    HandOverNurseId = GetUser().Id,
                    HandOverTimeNurse = DateTime.Now,
                    HandOverUnitNurseId = visit.SpecialtyId,
            ...
            {
                if (!eocHandOverCheckList.IsAcceptNurse && !eocHandOverCheckList.IsAcceptPhysician)
                {
                    eocHandOverCheckList.IsUseHandOverCheckList = isUseHandOverCheckList;
                    eocHandOverCheckList.ReceivingUnitPhysicianId = receiving;
                    eocHandOverCheckList.ReceivingUnitNurseId = receiving;
