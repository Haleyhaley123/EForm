    ...
    public class EOCCustomerController : BaseOPDApiController
    {
        ...
        public IHttpActionResult EocCustomer(Guid id)
        {
            ...
            return Content(HttpStatusCode.OK, new
            {
                ...
                Allergy = GetAllergyByVisit(visit),
        ...
        private VisitAllergyModel GetAllergyByVisit(EOC visitMode)
        {
            if (visitMode == null)
            ...
            return getEOCAllergyModel(new OPDQueryModel() { CustomerIsAllergy = null }, visitMode.Id);
        }
    }
}
