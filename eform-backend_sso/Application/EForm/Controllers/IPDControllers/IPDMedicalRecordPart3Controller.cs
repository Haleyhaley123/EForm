    ...
    public class IPDMedicalRecordPart3Controller : IPDMedicalRecordController
    {
        ...
        public IHttpActionResult SyncHistoryOfPatientIllnessAndAssessmentAPI(string Type, [FromBody] JObject request)
        {
            ...
            if (Type == "BMTIMMACH")
            {
                ...
                List<dynamic> datasHis = GetHistoryMedicalRecord(codes, part_2.Id);
        ...
        private dynamic GetHistoryMedicalRecord(string[] code, Guid part2_Id)
        {
            ...
            List<dynamic> datas_choices = new List<dynamic>();
