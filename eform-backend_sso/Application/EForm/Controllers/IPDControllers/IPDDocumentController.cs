...
namespace EForm.Controllers.IPDControllers
{
    ...
    public class IPDDocumentController : BaseIPDApiController
    {
        ...
        public IHttpActionResult DischargeCertificate(Guid id)
        {
            ...
            var Diagnosis = part_3_datas.FirstOrDefault(e => !e.IsDeleted && e.Code == "IPDMRPECDBCANS")?.Value;
        ...
        public IHttpActionResult IPDMedicalReportAPI(Guid id)
        {
            ...
            var diagnosisOptions = part_3_datas?.FirstOrDefault(e => e.Code == "IPDMRPTCDKTANS")?.Value;
