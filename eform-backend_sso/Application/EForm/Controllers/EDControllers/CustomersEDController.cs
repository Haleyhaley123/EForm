...
namespace EForm.Controllers.EDControllers
{
    ...
    public class CustomersEDController : BaseEDApiController
    {
        ...
        private VisitAllergyModel GetAllergyByVisit(ED visitMode)
        {
            if (visitMode == null)
            ...
            return getEDAllergyModel(new EDQueryModel() { CustomerIsAllergy = null }, visitMode.Id);
        }
    }
}