...
namespace EForm.Controllers.OPDControllers
{
    ...
    public class CustomerOPDController : BaseOPDApiController
    {
        ...
        public IHttpActionResult DetailCustomerAPI(Guid id, [FromUri] CustomerRequetDetailModel request)
        {
            ...
            var endNamestatus = opd.EDStatus.EnName;
            ...
            return Content(HttpStatusCode.OK, new
            {
                ...
                DischargeDate = (endNamestatus == "In hospital" || endNamestatus == "Waiting results") ? "" : opd.DischargeDate?.ToString(Constant.TIME_DATE_FORMAT_WITHOUT_SECOND),
        ...
        public IHttpActionResult UpdateManualCustomerAPI(Guid id, [FromBody] CustomerManualUpdateParameterModel request)
        {
            ...
            {
                if (!string.IsNullOrEmpty(customer.PID) && customer.PID != request.PID)
                ...
                if (local_customer != null)
                {
                    ...
                    MergeAnonymousCustomer(opd, local_customer.Id, customer);
        ...
        private void UpdateManualCustomer(Customer customer, OPD opd, CustomerManualUpdateParameterModel request)
        {
            ...
            var update_customer = JsonConvert.SerializeObject(new
            {
                ...
                IssueDate = request.ConvertedIssueDate,
                request.IssuePlace,
                request.IsVip,
            });
        ...
        private VisitAllergyModel GetAllergyByVisit(OPD visitMode)
        {
            if (visitMode == null)
            ...
            return getOPDAllergyModel(new OPDQueryModel() { CustomerIsAllergy = null }, visitMode.Id);
        }
