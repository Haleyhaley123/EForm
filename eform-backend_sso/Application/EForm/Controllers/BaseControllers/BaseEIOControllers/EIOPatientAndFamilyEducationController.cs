    ...
    public class EIOPatientAndFamilyEducationController : BaseApiController
    {
        ...
        protected dynamic BuildPatientAndFamilyEducationFormData(Guid edu_form_id,string fomCode, string visit_group)
        {
            ...
            return new
            {
                ...
                GroupContents = BuildGroupContentsOfEducationForm(edu_form_id),
                form.Version
            };
        }
        private Dictionary<string, dynamic> BuildGroupContentsOfEducationForm(Guid edu_form_id)
        {
            ...
            {
                var edu_form_content_formated = BuildEducationContentData(edu_form_content, edu_form_id);
        ...
        private dynamic BuildEducationContentData(dynamic edu_form_content, Guid edu_formId)
        {
            ...
            var confirm_edu = (from e in unitOfWork.EIOFormConfirmRepository.AsQueryable()
                               where !e.IsDeleted && e.FormId == edu_formId
                               && e.Note != null && e.Note.ToUpper().Equals(edu_form_content_id.ToString().ToUpper())
