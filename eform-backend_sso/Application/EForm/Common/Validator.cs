...
namespace EForm.Common
{
    public class Validator
    {
        public static bool ValidateDate(dynamic date_input)
        {
            try
            {
                DateTime date = DateTime.ParseExact(date_input, Constant.DATE_FORMAT, null);
                return true;
            }catch(Exception)
            {
                return false;
        ...
        public static bool ValidateDateTime(dynamic datetime_input)
        {
            try
            {
                DateTime date = DateTime.ParseExact(datetime_input, Constant.DATE_TIME_FORMAT, null);
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool ValidateDateTimeWithoutSecond(dynamic datetime_input)
        {
            try
            {
                DateTime date = DateTime.ParseExact(datetime_input, Constant.DATE_TIME_FORMAT_WITHOUT_SECOND, null);
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool ValidateTime(string time_input)
        {
            try
            {
                DateTime date = DateTime.ParseExact(time_input, Constant.TIME_FORMAT, null);
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool ValidateTimeDate(string datetime_input)
        {
            try
            {
                ...
                DateTime date = DateTime.ParseExact(datetime_input, Constant.TIME_DATE_FORMAT, null);
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool ValidateTimeDateWithoutSecond(string datetime_input)
        {
            try
            {
                ...
                DateTime date = DateTime.ParseExact(datetime_input, Constant.TIME_DATE_FORMAT_WITHOUT_SECOND, null);
                return true;
            }
            catch (Exception)
            {
