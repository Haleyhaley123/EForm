...
namespace Admin.App_Start
{
    public partial class Start_up
    {
        ...
        {
            ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12 | SecurityProtocolType.Ssl3; // only
            ...
            app.UseOpenIdConnectAuthentication(
                new OpenIdConnectAuthenticationOptions
                {
                    ...
                    Notifications =
                        ...
                        {
                            AuthorizationCodeReceived = Start_up.AuthorizationCodeRecieved,
                            AuthenticationFailed = Start_up.AuthenticationFailed,
                            RedirectToIdentityProvider = Start_up.RedirectToIdentityProvider,
                            SecurityTokenValidated = Start_up.SecurityTokenValidated,
                        },
                });
        ...
        public static Task RedirectToIdentityProvider(RedirectToIdentityProviderNotification<OpenIdConnectMessage, OpenIdConnectAuthenticationOptions> notification)
        {
            ...
            if (notification.Request.Uri.AbsolutePath == url.Action("SessionChanged", "Account"))
            {
                ...
                else
                {
                    ...
                    notification.Response.Redirect(url.Action("SignOut", "Account") + "?" + redirectUrl);
        ...
        public static Task AuthenticationFailed(AuthenticationFailedNotification<OpenIdConnectMessage, OpenIdConnectAuthenticationOptions> notification)
        {
            ...
            else
            {
                ...
                notification.Response.Redirect("Home/Logins");
                notification.HandleResponse();
            }
