            ...
            if (HttpContext.Current.User != null)
            {
                if (HttpContext.Current.User.Identity.IsAuthenticated)
                {
                    ...
                    //{
                        ...
                        var session = HttpContext.Current.Request.Cookies[FormsAuthentication.FormsCookieName];
                    if (session != null)
                    {
                        ...
                        else
                        {
                            ...
                            FormsAuthenticationTicket authTicket = FormsAuthentication.Decrypt(session.Value);
